...
if __name__ == "__main__":
    ...
    (interval_seq, all_cali_data, all_t, all_cali_t, all_cache) = torch.load("./calibration/bedroom{}_cache{}_{}.pth".format(args.ddim_steps, args.replicate_interval, args.mode))
