...
def load_model_for_layer_info():
    ...
    print(f"Loading model from ./mainldm/models/ldm/lsun_churches256/model.ckpt")
    pl_sd = torch.load("./mainldm/models/ldm/lsun_churches256/model.ckpt", map_location="cpu")
    sd = pl_sd["state_dict"]
