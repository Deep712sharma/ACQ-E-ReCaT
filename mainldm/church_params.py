...
if __name__ == "__main__":
    ...
    interval_seq, all_cali_data, all_t, all_cali_t, all_cache = \
            torch.load("./calibration/church{}_cache{}_{}.pth".format(args.ddim_steps, args.replicate_interval, args.mode))
    ...
    (a_list, b_list) = torch.load(f"./error_dec/church/pre_cacheerr_abCov_interval{args.replicate_interval}_list.pth")
    ...
    if args.ptq:
        ...
        torch.save((q_unet.model.output_blocks[-1][0].skip_connection.weight_quantizer.delta, q_unet.model.output_blocks[-1][0].skip_connection.weight_quantizer.zero_point), "./error_dec/church/weight_quantizer_params_aftercacheadd.pth") #_aftercacheadd
        torch.save((q_unet.model.output_blocks[-1][0].skip_connection.act_quantizer.delta, q_unet.model.output_blocks[-1][0].skip_connection.act_quantizer.zero_point), "./error_dec/church/act_quantizer_params_aftercacheadd.pth")
        torch.save((q_unet.model.output_blocks[-1][0].skip_connection.org_weight, q_unet.model.output_blocks[-1][0].skip_connection.org_bias), "./error_dec/church/weight_params.pth")
        torch.save((q_unet.model.output_blocks[-1][0].in_layers[2].weight_quantizer.delta, q_unet.model.output_blocks[-1][0].in_layers[2].weight_quantizer.zero_point), "./error_dec/church/weight_quantizer_norm_params_aftercacheadd.pth")
        torch.save((q_unet.model.output_blocks[-1][0].in_layers[2].act_quantizer.delta, q_unet.model.output_blocks[-1][0].in_layers[2].act_quantizer.zero_point), "./error_dec/church/act_quantizer_norm_params_aftercacheadd.pth")
        torch.save((q_unet.model.output_blocks[-1][0].in_layers[2].org_weight, q_unet.model.output_blocks[-1][0].in_layers[2].org_bias), "./error_dec/church/weight_norm_params.pth")
        torch.save((q_unet.model.output_blocks[-1][0].in_layers[0].weight, q_unet.model.output_blocks[-1][0].in_layers[0].bias), "./error_dec/church/groupnorm_norm_params.pth")
