...
def load_model_for_layer_info():
    """Load the Stable Diffusion model for layer information extraction."""
    from omegaconf import OmegaConf
    from ldm.util import instantiate_from_config
    
    config = OmegaConf.load("./mainldm/configs/stable-diffusion/v1-inference.yaml")
    
    logger.info(f"Loading Stable Diffusion model from ./mainldm/models/ldm/stable-diffusion-v1/sd-v1-4.ckpt")
    pl_sd = torch.load("./mainldm/models/ldm/stable-diffusion-v1/sd-v1-4.ckpt", map_location="cpu")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Cluster management for Stable Diffusion: create, split, or auto-fix cluster files"
    )
    ...
    parser.add_argument("--clustering_dir", type=str, default="./clustering_output_stable",
                       help="Directory to check for cluster files")
    parser.add_argument("--output_dir", type=str, default="./clustering_per_layer_stable",
