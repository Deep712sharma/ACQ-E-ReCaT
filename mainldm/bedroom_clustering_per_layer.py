...
def create_per_layer_clusters(output_dir = "./cluster_layer_bedroom", n_clusters=100):
    ...
    try:
        ...
        pl_sd = torch.load("./mainldm/models/ldm/lsun_beds256/model.ckpt", map_location="cpu")
        sd = pl_sd["state_dict"]
